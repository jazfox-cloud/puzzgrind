...
export default function NotFound() {
  return <main className="mx-auto grid min-h-screen max-w-3xl place-items-center px-6 py-16 text-center">
    <section>
      ...
      <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-[var(--ink-soft)]">The page may have moved, or the link may no longer be valid. Return to the puzzle center or choose today&apos;s game.</p>
      <nav aria-label="404 recovery" className="mt-9 flex flex-wrap justify-center gap-3">
        ...
        <Link className="rounded-full bg-blue-950 px-6 py-3 font-bold text-white" href="/games/lexi-daily">Play Lexi Daily</Link>
      </nav>
    </section>
  </main>;
}
