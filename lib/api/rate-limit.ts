...
export const RATE_LIMIT_POLICIES = {
  ...
  lexiGuess: { binding: "RATE_LIMIT_LEXI_GUESS", limit: 12, period: 60 },
  lexiHint: { binding: "RATE_LIMIT_LEXI_HINT", limit: 4, period: 60 },
  lexiLeaderboardQuery: { binding: "RATE_LIMIT_LEXI_READ", limit: 60, period: 60 },
  lexiLeaderboardSubmit: { binding: "RATE_LIMIT_LEXI_SUBMIT", limit: 6, period: 60 },
  lexiSessionStart: { binding: "RATE_LIMIT_LEXI_START", limit: 12, period: 60 },
  lexiToday: { binding: "RATE_LIMIT_LEXI_READ", limit: 60, period: 60 },
